...
export const initializeApp = async () => {
  ...
  if (settings) {
    ...
    const frontendSettings = {
      ...
      enableRegistration: 'enable_registration' in settings ? settings.enable_registration : true,
      requireEmailVerification: 'require_email_verification' in settings ? settings.require_email_verification : true,
      maxStoragePerUser: 'max_storage_per_user' in settings ? settings.max_storage_per_user : 100
    };
