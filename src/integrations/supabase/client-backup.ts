...
const SUPABASE_PUBLISHABLE_KEY =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Ind5bWlwZmd1dXpwc2FjcXJzYWxoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDQ4NzA1MjUsImV4cCI6MjA2MDQ0NjUyNX0.T9pyeXpnbN2Fn2ZtWK4Gwu9ou6tQQ-iMzGlhh5KrCx8";
...
export const initializeApp = async () => {
  ...
  if (settings) {
    ...
    const frontendSettings = {
      ...
      siteDescription: (settings as any).site_description || "",
      contactEmail: (settings as any).contact_email || "",
      siteUrl: settings.site_url || "",
      logo: settings.logo || null,
      favicon: (settings as any).favicon || null,
      ...
      enableRegistration:
        "enable_registration" in settings ? settings.enable_registration : true,
      requireEmailVerification:
        "require_email_verification" in settings
          ? settings.require_email_verification
          : true,
      maxStoragePerUser:
        "max_storage_per_user" in settings
          ? settings.max_storage_per_user
          : 100,
    };
